# psf5.py  (PSF5: 의사소통 - RandomForest 버전)
...
def run_psf5():
    ...
    model = RandomForestClassifier(
        ...
        random_state=42,
        n_jobs=-1,         # CPU 병렬 처리
        class_weight=None, # 필요하면 'balanced'로 조정 가능
    )
    ...
    print("\n=== [PSF5][RandomForest] Feature Importance ===")

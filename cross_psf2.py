# psf2_cv.py  (PSF2: 장비 및 기기, 교차검증 버전)
...
def run_cross_psf2():
    ...
    print("=== [PSF2] 5-Fold 교차검증 Accuracy ===")
    ...
    print("=== [PSF2] 교차검증 분류 성능 (out-of-fold) ===")
    ...
    print("\n=== [PSF2] Feature Importance (전체 데이터로 학습한 최종 모델) ===")
    ...
    pred_012 = int(final_model.predict(x_new)[0])
    pred_123 = pred_012 + 1
    label123_to_text = {1: "좋음", 2: "보통", 3: "나쁨"}

    print("\n=== [PSF2] 새 설문 응답 예측 (최종 모델) ===")
    print("입력 조건:", example_conds)
    print("예측 결과 (0/1/2 라벨):", pred_012)
